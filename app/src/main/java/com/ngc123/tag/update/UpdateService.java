...
import com.ngc123.tag.util.FileUtil;
...
public class UpdateService extends Service{
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(FileUtil.isCreateFileSucess == true){
            ...
            Toast.makeText(this, "文件目录读取失败", Toast.LENGTH_SHORT).show();
            /***************stop service************/
            stopSelf();
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case DOWN_OK:
                    ...
                    builder.setContentTitle(app_name).setContentText("下载成功").setSmallIcon(R.mipmap.ic_launcher).setContentIntent(pendingIntent);
...
//                    notification.setLatestEventInfo(UpdateService.this, app_name, getString(R.string.down_fail), null);
                   Notification.Builder builder1=new Notification.Builder(App.getApp());
                    builder1.setContentTitle(app_name).setContentText("下载失败").setSmallIcon(R.mipmap.ic_launcher).setContentIntent(pendingIntent);
    ...
    public void createNotification() {
        ...
        contentView.setTextViewText(R.id.id_notification_Title, app_name + "正在下载");
        contentView.setTextViewText(R.id.id_notification_Percent, "0%");
        contentView.setProgressBar(R.id.id_notification_Progress, 100, 0, false);
...
//			}
            ...
            if (updateCount == 0 || (downloadCount * 100 / totalSize - down_step) >= updateCount) {
                ...
                // 改变通知栏
                contentView.setTextViewText(R.id.id_notification_Percent,updateCount + "%");
                contentView.setProgressBar(R.id.id_notification_Progress, 100,updateCount, false);
                notification.contentView = contentView;
                notificationManager.notify(R.layout.notification_item, notification);
            }
        }
