...
*
*/
public class MyLikeReceiver extends BroadcastReceiver {
    @Override
    public void onReceive(Context context, Intent intent) {
        String action = intent.getAction();
        if (action.equals("com.ngc.tag.like")) {
            Intent it = new Intent(context, LikeActivity.class);
            ...
            try {
                ...
                contentValues.put("content", "赞了你");
                db.insert("like", null, contentValues);
