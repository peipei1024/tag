 ...
 */
public class MeFolloweesActivity extends Activity implements SwipeRefreshLayout.OnRefreshListener {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    ToastUtils.toast(MeFolloweesActivity.this, "获取数据失败");
                    break;
                case 2:
                    ...
                    break;
                case 4:
                    ToastUtils.toast(MeFolloweesActivity.this, "你已经在别处登录，请重新登录");
                    idSwipe.setRefreshing(false);
                    break;
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.me_followees);
