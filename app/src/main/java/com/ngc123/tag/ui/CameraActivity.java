...
public class CameraActivity extends CameraBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cramera_main);
    ...
    private void initView() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceCallback());ViewGroup.LayoutParams layout = cameraGrid.getLayoutParams();
    ...
    private void addPhoto(PhotoItem photoItem) {
        ...
        if (StringUtils.isNotBlank(photoItem.getImageUri())) {
            ...
            ImageLoaderUtils.displayLocalThumb(photoItem.getImageUri(), photo,photoWidth,photoWidth);
        } else {
