...
public class Chat_RecordButton extends Button {
  ...
  public Chat_RecordButton(Context context) {
    super(context);
    init();
  }

  public Chat_RecordButton(Context context, AttributeSet attrs, int defStyle) {
    super(context, attrs, defStyle);
    init();
  }

  public Chat_RecordButton(Context context, AttributeSet attrs) {
    super(context, attrs);
    init();
  }
  ...
  private void finishRecord() {
    ...
    if (intervalTime < MIN_INTERVAL_TIME) {
      Toast.makeText(getContext(), "说多点吧～", Toast.LENGTH_SHORT).show();
      removeFile();
      return;
    }
  ...
  private void cancelRecord() {
    ...
    setBackgroundResource(BACK_IDLE);
    recordIndicator.dismiss();
    Toast.makeText(getContext(), "取消录音",
